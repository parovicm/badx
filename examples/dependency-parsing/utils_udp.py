...
class DependencyParsingTrainer(Trainer):
    ...
    def evaluate(
        ...
        output = self._prediction_loop(eval_dataloader, description="eval")
    ...
    def predict(self, test_dataset: Dataset) -> PredictionOutput:
        ...
        output = self._prediction_loop(test_dataloader, description="pred")
    ...
    def _prediction_loop(
        ...
        results["loss"] = np.mean(eval_losses)

        results = {f'{description}_{k}': v for k, v in results.items()}
